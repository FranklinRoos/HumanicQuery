...
//var url = "http://".$_SERVER['HTTP_HOST']."/query/application/modules/KandidatenQuery/php/QueryFuncties.php";
...
//url waarin de php file staat die data ophaalt
//var url = "http://".$_SERVER['HTTP_HOST']."/query/application/modules/KandidatenQuery/php/andereFunctieQuery.php";
var url = "http://localhost:7777/query/application/modules/KandidatenQuery/php/andereFunctieQuery.php";
...
//arrau doorlopen en verschillende option aanmaken 
        for(i = 0; i < arr.length; i++) {
            if (arr[i].FunctieId !== 99){
                ...
                functies += '<div class="functieOmschrijving col-sm-7" >';   
                functies += '<textarea id="omschrijving' + i + '"  rows="1" cols="35" >'  + arr[i].Omschrijving + '</textarea></div>';                
                functies += "</div>";
                functies += "<div></div>";
        ...
        for (i=0; i < aantalAndereFunctie; i++){
            ...
            if ($(elem).prop('checked')){
                ...
                $.ajax({
                    ...
                    //url:"http://".$_SERVER['HTTP_HOST']."/query/application/modules/KandidatenQuery/php/toevoegenAndersFunctie.php",
                    url:"http://localhost:7777/query/application/modules/KandidatenQuery/php/toevoegenAndersFunctie.php",
        ...
        for (i=0; i < aantalWijzigFunctie; i++){
            ...
            if ($(elem).prop('checked')){
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json",
                    //url:"http://".$_SERVER['HTTP_HOST']."/query/application/modules/KandidatenQuery/php/updateFunctie.php",
                    url:"http://localhost:7777/query/application/modules/KandidatenQuery/php/updateFunctie.php",
